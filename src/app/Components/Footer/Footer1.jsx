                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                            <div className="single-footer-widget">
                                <div className="widget-head">
                                    <Link href="/">
                                        <Image src="/assets/img/logo/logo.svg" alt="img" width={167} height={58} />
                                    </Link>
                                </div>
                                <div className="footer-content">
                                    <p>
                                        Welcome to Ambrosia Starbuds, where delicious food, friendly service, and a relaxed vibe come together. Sit back, savor the flavors, and enjoy every bite.
                                    </p>
