                ...
                <div className="row gy-5 gx-60">
                    <div className="col-xl-6">
                        <div className="chefe-thumb">
                            <Image className="img-fluid" src="/assets/img/chefe/imgi_135_image.webp" alt="img" width={618} height={689} />
                        </div>
                    </div>
                    <div className="col-xl-6">
                        <div className="chefe-details-wrapper style1">
                            <h2>Name:Merry Jhonson </h2>
                            <h6><span className="text-black fw-bold">specialization:</span>Indian Cuisine Serve Managment Human Interacation Hotel Management</h6>
                            <p><span className="text-black fw-bold">Address:</span>Shop No. GF-18 Signate Plaza Complex Krunal Char Rasta Gotri-Samta Road, Laxmipura, Gotri, Vadodara, Gujarat-390021</p>
                            <h5>Skills:</h5>
                            <div className="progress-wrap wow fadeInUp" data-wow-delay=".2s">
                                <div className="progress-meta">
                                    <div className="title">Cooking Indian</div>
